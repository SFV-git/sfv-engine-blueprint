...
Tracks every tool's current state in the SFV Engine.

Status types:
- MENTIONED: came up in conversation
- RESEARCHING: actively evaluating
- APPROVED: Will confirmed it's in the stack
- REJECTED: decided against
- INSTALLED: physically installed and working
- ACTIVE: installed and being used
- FUTURE: confirmed for later phase
